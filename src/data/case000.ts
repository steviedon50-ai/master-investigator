...
export const puzzles: Puzzle[] = [
  ...
  },
  {
    ...
    explanation:
      ...
      'cases build their word puzzles in your chosen language rather than translating an English one.',
    rewards: {
  ...
  },
  {
    ...
    description:
      'Open the notebook page. It describes four people by what they did. Name each one, ' +
    ...
    explanation:
      'Research answers accept alternate spellings, full names and short names. A surname ' +
      'alone is enough unless the case says otherwise.',
    rewards: {
      evidence: ['ev-ledger'],
  ...
  },
  {
    ...
    description:
      'Four of your items give a date for the break-in. Read them again and compare. ' +
      'One disagrees with the rest. Name the unreliable source and say what is wrong with it.',
    data: {
    ...
    explanation:
      'The watch is a red herring: plausible, physical, and connected to nothing. The cutting ' +
      'is worse than useless — it is wrong, and it was included to see whether you would take ' +
      'print at face value. Mark contradicted evidence rather than deleting it. Being wrong is ' +
      'itself a fact about a source.',
    rewards: {
      setStatus: [
  ...
  },
  {
    ...
    explanation:
      'In a real case a meta-puzzle takes the outputs of earlier puzzles — a date, a key, ' +
      'a person, a place — and makes them one answer. This one did the same with the name ' +
      'you were never told.',
