...
export const puzzles: Puzzle[] = [
  ...
  },
  {
    ...
    explanation:
      'Three ordinary entries made the fourth visible. A planted clue needs normal neighbours ' +
  ...
  },
  {
    ...
    description:
      'Four of your items give a date for the break-in. They do not agree. ' +
      'Name the unreliable source and say what is wrong with it.',
    data: {
